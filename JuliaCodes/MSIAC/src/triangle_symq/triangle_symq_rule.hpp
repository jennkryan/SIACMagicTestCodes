...
extern "C" double r8vec_sum ( int n, double a[] );
...
extern "C" int rule_full_size ( int mmax );
...
double *simplex_to_triangle ( double tvert1[], double tvert2[], double tvert3[], 
  double s[] );
void timestamp ( );
extern "C" double triangle_area ( double vert1[], double vert2[], double vert3[] );
...
extern "C" void triasymq ( int n, double vert1[], double vert2[], double vert3[], 
